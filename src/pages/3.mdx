...
To keep things simpler, I'll be using one page for a while. The user experience for people using screenreaders can be different than the experience for people looking at a screen, and it's easier to keep reading information on one page. 

<p>
  That is the most important takeaway that you can come away with today: <br /><br />
  <pre>
  <em>
