...
<p>The full list of requirements that we follow are documented in the W.C.A.G. 2.1 guidelines, listed <a href="https://www.w3.org/TR/WCAG21/">here</a>.</p>
...
It's already a good design principle to make your interfaces as intuitive and clear as possible, for the sake of all users. When you rely on users to intuitively understand how features are supposed to work, that may be more of a challenge for some users than others.
